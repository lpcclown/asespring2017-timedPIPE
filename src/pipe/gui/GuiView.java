...
//      private PlaceTransitionObject newPortin(Point p){
//          p = adjustPoint(p, view.getZoom());
//          
//          pnObject = new SAMPortin(Grid.getModifiedX(p.x), Grid.getModifiedY(p.y));
//          model.addPetriNetObject(pnObject);
//          view.addNewPetriNetObject(pnObject);
//          return (PlaceTransitionObject)pnObject;
//       }
      ...
      public void mousePressed(MouseEvent e){
         ...
         if (SwingUtilities.isLeftMouseButton(e)) {
            ...
            switch (mode){
               ...
               case Pipe.ARC:
               case Pipe.INHIBARC: case Pipe.BIDIRECTARC:
