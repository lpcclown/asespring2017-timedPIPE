...
public class TransitionEditor extends javax.swing.JPanel {
	 ...
	 */
	public TransitionEditor(JRootPane _rootPane, Transition _transition, DataLayer _pnmlData, GuiView _view) {
		...
		lowerBound = transition.getLowerBound();
		upperBound = transition.getUpperBound();
	...
	private void timedTransition() {
		...
		lowerBoundLabel.setText("LowerBound£º");
		lowerBoundTextField.setText("" + transition.getLowerBound());

		upperBoundLabel.setText("UpperBound£º");
		upperBoundTextField.setText("" + transition.getUpperBound());
	...
	private void initComponents() {
		...
		gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
		gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
		transitionEditorPanel.add(lowerBoundLabel, gridBagConstraints);
		...
		gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
		gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
		transitionEditorPanel.add(lowerBoundTextField, gridBagConstraints);
		...
		gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
		gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
		transitionEditorPanel.add(upperBoundLabel, gridBagConstraints);
		...
		gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
		gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
		transitionEditorPanel.add(upperBoundTextField, gridBagConstraints);
	...
	private void rateTextFieldCaretUpdate(javax.swing.event.CaretEvent evt) {// GEN-FIRST:event_rateTextFieldCaretUpdate
		try {
			if ((rateComboBox.getSelectedIndex() > 0) && (((RateParameter) rateComboBox.getSelectedItem())
					.getValue() != Double.parseDouble(rateTextField.getText()))) {
	...
	private void okButtonHandler(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_okButtonHandler
		...
		if (timedRadioButton.isSelected() != timed) {
			view.getUndoManager().addEdit(transition.setTimed(!timed));
		}

		if (infiniteServerRadioButton.isSelected() != infiniteServer) {
			view.getUndoManager().addEdit(transition.setInfiniteServer(!infiniteServer));
		}
		...
		if (rateComboBox.getSelectedIndex() > 0) {
			...
			RateParameter parameter = (RateParameter) rateComboBox.getSelectedItem();
			if (parameter != rParameter) {

				if (rParameter != null) {
					// The rate parameter has been changed
					view.getUndoManager()
							.addEdit(transition.changeRateParameter((RateParameter) rateComboBox.getSelectedItem()));
				} else {
					// The rate parameter has been changed
					view.getUndoManager()
							.addEdit(transition.setRateParameter((RateParameter) rateComboBox.getSelectedItem()));
				}
			}
		} else {
			...
			try {
				...
				int newLowerBound = Integer.parseInt(lowerBoundTextField.getText());
				if (newLowerBound != lowerBound) {
					view.getUndoManager().addEdit(transition.setLowerBound(newLowerBound));
				}
				int newUpperBound = Integer.parseInt(upperBoundTextField.getText());
				if (newUpperBound != upperBound) {
					view.getUndoManager().addEdit(transition.setUpperBound(newUpperBound));
				}
