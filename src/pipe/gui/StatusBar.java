...
public class StatusBar 
   ...
   public String textforArc =
           ...
           "[Mouse wheel -> rotate]";
   public String textforBidirectArc =
           "Bidirect Arc Mode: Right-Click on an Bidirectional Arc to see menu options " +
           "[Mouse wheel -> rotate]";
   ...
   public String textforComponent =
       "Component Mode: Right click on a Component to see menu options ";
   public String textforPortIn =
       "PortIn Mode: Right click on a Port to see menu options ";
   public String textforPortOut =
       "PortOut Mode: Right click on a Port to see menu options ";
