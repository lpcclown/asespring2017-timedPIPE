...
public abstract class PlaceTransitionObject 
   ...
   private LinkedList<Arc> connectTo = new LinkedList<>();
   private LinkedList<Arc> connectFrom = new LinkedList<>();
...
//         System.out.println("DEBUG: removeToArc_ko");
   ...
   abstract public boolean isMergeable(final PlaceTransitionObject pObject);
}
