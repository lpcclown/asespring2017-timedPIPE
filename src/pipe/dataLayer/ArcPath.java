...
public class ArcPath 
   ...
   private static Stroke proximityStroke = 
            new BasicStroke(Pipe.ARC_PATH_PROXIMITY_WIDTH/*, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER*/);
...
//      
//      path.lineTo(currentPoint.getPoint().x , currentPoint.getPoint().y+20);
//      path.moveTo(currentPoint.getPoint().x, currentPoint.getPoint().y);
//      path.lineTo(currentPoint.getPoint().x, currentPoint.getPoint().y-20);
//      path.curveTo(currentPoint.getPoint().x, currentPoint.getPoint().y-20, currentPoint.getPoint().x+40, currentPoint.getPoint().y,currentPoint.getPoint().x, currentPoint.getPoint().y+20);
//      path.moveTo(currentPoint.getPoint().x, currentPoint.getPoint().y);
...
//            path.lineTo(currentPoint.getPoint().x, currentPoint.getPoint().y-20);
//            path.curveTo(currentPoint.getPoint().x, currentPoint.getPoint().y-20, currentPoint.getPoint().x+40, currentPoint.getPoint().y,currentPoint.getPoint().x, currentPoint.getPoint().y+20);
//            path.moveTo(currentPoint.getPoint().x+40, currentPoint.getPoint().y);
