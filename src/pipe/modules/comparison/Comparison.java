...
public class Comparison 
   ...
   private JCheckBox compareBidirectionalArcID;
   private JCheckBox compareBidirectionalArcName;
   private JCheckBox compareBidirectionalArcWeighting; 
   ...
   public void run(DataLayer pnmlData) {
      ...
      JPanel bidirectionalArcPanel = new JPanel();
      bidirectionalArcPanel.setLayout(new BoxLayout(bidirectionalArcPanel, BoxLayout.LINE_AXIS));
      bidirectionalArcPanel.setBorder(new TitledBorder(new EtchedBorder(), "Bidirectional Arcs"));
      bidirectionalArcPanel.add(compareBidirectionalArcID        = new JCheckBox("ID", true));
      bidirectionalArcPanel.add(compareBidirectionalArcName      = new JCheckBox("Name", true));
      bidirectionalArcPanel.add(compareBidirectionalArcWeighting = new JCheckBox("Weighting", true));      
      ...
      options.add(bidirectionalArcPanel);
   ...
   ActionListener compareButtonClick=new ActionListener() {
      ...
      public void actionPerformed(ActionEvent arg0) {
         ...
         if (compareBidirectionalArcID.isSelected() || compareBidirectionalArcName.isSelected() ||
                 compareBidirectionalArcWeighting.isSelected()) {
            s += compareArcs(sourceDataLayer.getBidirectionalArcs(),
                     comparisonDataLayer.getBidirectionalArcs(),
                     compareArcID.isSelected(),
                     compareArcName.isSelected(),
                     compareArcWeighting.isSelected(),
                     true);
